...
São projetos de PO UI com ADVPL que têm como princípio a transformação de um simples MVC em algo mais interativo e atual. Utiliza diversas skills do Claude, como a superpowers. Cobre as telas de **Ordem de Serviço**, **Chamados** e **Agenda** usadas na intraweb/portal da Empresa Ápia Consultoria e Sistemas.
