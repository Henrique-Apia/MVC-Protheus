...
/**
 * Cronômetro visível "Buscando... Xs" pra qualquer busca real na tela de
 * chamados (carga inicial, "Carregar mais resultados", busca avançada).
 * Alimentado pelo ChamadosRestAdapterInterceptor - contador de requisições
 * em voo, não um único boolean, porque o po-page-dynamic-table pode
 * disparar mais de uma chamada quase junto (ex: paginação).
 */
