...
const CHAMADOS_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOS`;
const CHAMADOS_ASSUMIR_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOSASSUMIR`;
const CHAMADOS_EXCLUIR_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOSEXCLUIR`;
const CHAMADOS_INCLUIR_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOSINCLUIR`;
const CHAMADOS_ALTERAR_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOSALTERAR`;
const CHAMADOS_AGENDAR_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOSAGENDAR`;
const CHAMADOS_VERAGENDA_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOSVERAGENDA`;
const CHAMADOS_ANOTACOES_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOSANOTACOES`;
const CHAMADOS_ANOTACOES_INCLUIR_URL = `${PROTHEUS_REST_BASE}/rest/CNSACHAMADOSANOTACOESINCLUIR`;
