...
import { ComponenteResposta, TipoLupa } from './componente.model';

const COMPONENTES_URL = '/rest/CNSACOMPONENTES';

/**
 * Consultas de apoio ("lupas") usadas nos campos de consulta das telas de
 * Incluir/Editar Chamado e OS - espelha o WSRESTFUL CNSACOMPONENTES
 * (ComponentesRest.prw). Compartilhado entre as duas features (ver plano
 * CNSHUB, M5) - antes de M5 cada uma tinha sua propria copia.
 */
