...
const OS_URL = '/rest/CNSAOS';
const OS_INCLUIR_URL = '/rest/CNSAOSINCLUIR';
const OS_ALTERAR_URL = '/rest/CNSAOSALTERAR';
const OS_EXCLUIR_URL = '/rest/CNSAOSEXCLUIR';
const OS_COPIAR_URL = '/rest/CNSAOSCOPIAR';
